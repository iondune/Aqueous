...
void CGwenOpenGLRenderer::Begin()
{
...
void CGwenOpenGLRenderer::End()
{
	Flush();
}

void CGwenOpenGLRenderer::Flush()
{
...
void CGwenOpenGLRenderer::AddVert( int x, int y, float u, float v )
{
...
void CGwenOpenGLRenderer::DrawFilledRect( Gwen::Rect rect )
{
...
void CGwenOpenGLRenderer::SetDrawColor( Gwen::Color color )
{
	glColor4ubv( ( GLubyte* ) &color );
	m_Color = color;
}

void CGwenOpenGLRenderer::StartClip()
{
	Flush();
...
void CGwenOpenGLRenderer::EndClip()
{
	Flush();
	glDisable( GL_SCISSOR_TEST );
};

void CGwenOpenGLRenderer::DrawTexturedRect( Gwen::Texture* pTexture, Gwen::Rect rect, float u1, float v1, float u2, float v2 )
{
...
void CGwenOpenGLRenderer::LoadTexture( Gwen::Texture* pTexture )
{
...
void CGwenOpenGLRenderer::FreeTexture( Gwen::Texture* pTexture )
{
	GLuint* tex = ( GLuint* ) pTexture->data;
...
Gwen::Color CGwenOpenGLRenderer::PixelColour( Gwen::Texture* pTexture, unsigned int x, unsigned int y, const Gwen::Color & col_default )
{
	GLuint* tex = ( GLuint* ) pTexture->data;
...
bool CGwenOpenGLRenderer::InitializeContext( Gwen::WindowProvider* pWindow )
{
#ifdef _WIN32
...
bool CGwenOpenGLRenderer::ShutdownContext( Gwen::WindowProvider* pWindow )
{
#ifdef _WIN32
...
bool CGwenOpenGLRenderer::PresentContext( Gwen::WindowProvider* pWindow )
{
#ifdef _WIN32
	HWND pHwnd = ( HWND ) pWindow->GetWindow();
...
bool CGwenOpenGLRenderer::ResizedContext( Gwen::WindowProvider* pWindow, int w, int h )
{
#ifdef _WIN32
	RECT r;
...
bool CGwenOpenGLRenderer::BeginContext( Gwen::WindowProvider* pWindow )
{
...
bool CGwenOpenGLRenderer::EndContext( Gwen::WindowProvider* pWindow )
{
	return true;
}
