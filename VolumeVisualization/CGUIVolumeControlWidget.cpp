	...
	: VolumeControl(CProgramContext::get().Scene.VolumeSceneObject->Control), MainState(CMainState::get())
{
	...
	Window->SetBounds(1200, 0, 330, 450);
	...
	// Slider Panel
	{
		...
		SliderLabel->SetBounds(10, 10, 300, 40);
